...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.17.20.0 (NJsonSchema v9.10.63.0 (Newtonsoft.Json v9.0.0.0)) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAll1(): Observable<ListResultDtoOfEmployeeDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetAll1";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAll1(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAll1(<any>response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfEmployeeDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfEmployeeDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll1(response: HttpResponseBase): Observable<ListResultDtoOfEmployeeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfEmployeeDto.fromJS(resultData200) : new ListResultDtoOfEmployeeDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfEmployeeDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfEmployeeDto> {
...
export class TaskServiceProxy {
    ...
    /**
     * @param taskState (optional) 
     * @return Success
     */
    getAll(taskState: TaskState | null | undefined): Observable<ListResultDtoOfTaskListDto> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetAll?";
        if (taskState !== undefined)
            url_ += "TaskState=" + encodeURIComponent("" + taskState) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAll1(): Observable<TaskListDto1[]> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetAll1";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TaskListDto1[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<TaskListDto1[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll1(response: HttpResponseBase): Observable<TaskListDto1[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(TaskListDto1.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<TaskListDto1[]>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: CreateTaskInput | null | undefined): Observable<TaskListDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TaskListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TaskListDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<TaskListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? TaskListDto.fromJS(resultData200) : new TaskListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TaskListDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: TaskListDto | null | undefined): Observable<TaskListDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<TaskListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAsync(id: number | null | undefined): Observable<TaskListDto> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetAsync?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAsync(response: HttpResponseBase): Observable<TaskListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ListResultDtoOfEmployeeDto implements IListResultDtoOfEmployeeDto {
    items: EmployeeDto[] | undefined;

    constructor(data?: IListResultDtoOfEmployeeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfEmployeeDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfEmployeeDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfEmployeeDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfEmployeeDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfEmployeeDto {
    items: EmployeeDto[] | undefined;
}
...
export class TaskListDto1 implements ITaskListDto1 {
    id: number | undefined;
    tenantId: number | undefined;
    creationTime: moment.Moment | undefined;
    title: string | undefined;
    description: string | undefined;
    state: TaskListDto1State | undefined;
    name: string | undefined;

    constructor(data?: ITaskListDto1) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TaskListDto1 {
        data = typeof data === 'object' ? data : {};
        let result = new TaskListDto1();
        result.init(data);
        return result;
    }
...
export interface ITaskListDto1 {
    id: number | undefined;
    tenantId: number | undefined;
    creationTime: moment.Moment | undefined;
    title: string | undefined;
