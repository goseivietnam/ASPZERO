...
using Shouldly;
using Xunit;
using MyFisrtProjectASPNETZERO.Sessions;

namespace MyFisrtProjectASPNETZERO.Tests.Sessions
{
    public class SessionAppService_Tests : MyFisrtProjectASPNETZEROTestBase
    {
